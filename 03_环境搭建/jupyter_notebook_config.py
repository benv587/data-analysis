...
#  password.
#  Default: ''
c.NotebookApp.password = "argon2:$argon2id$v=19$m=10240,t=10,p=8$Xa+uM7rbsx17QpPIeZGhpA$fCQiOHiiRPS/svRAuUHiHg"
...
#  Choices: any of ['sha224', 'sha256', 'sha384', 'sha3_384', 'sha3_256', 'sha3_512', 'md5', 'sha512', 'sha1', 'blake2s', 'sha3_224', 'blake2b']
#  Default: 'sha256'
